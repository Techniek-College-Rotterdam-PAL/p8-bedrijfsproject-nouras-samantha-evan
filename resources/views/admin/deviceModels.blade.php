...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md mb-8">
        <h2 class="text-2xl font-medium text-gray-700 mb-4">Create a Device Model</h2>
        <form action="{{ route('admin.storeDeviceModel') }}" method="POST" class="flex items-center space-x-4">
            ...
            <div class="flex-1">
                <label for="type_id" class="block text-gray-700 font-medium mb-2">Device Type:</label>
    ...
    <div class="mb-6">
        <label for="filter_type" class="block text-gray-700 font-medium mb-2">Filter by Device Type:</label>
